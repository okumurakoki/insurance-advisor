...
async function testAxaJune() {
    try {
        console.log('================================================================================');
        console.log('Testing: AXA June PDF (ul_m_2506.pdf)');
        console.log('================================================================================');

        const pdfBuffer = await fs.readFile('/Users/kohki_okumura/Documents/ul_m_2506.pdf');
        ...
        console.log(`\n✅ Successfully parsed AXA June PDF!`);
...
testAxaJune().catch(console.error);
