...
async function testSovaniJune() {
    try {
        console.log('================================================================================');
        console.log('Testing: SOVANI June PDF (sovanifull202506.pdf)');
        console.log('================================================================================');

        const pdfBuffer = await fs.readFile('/Users/kohki_okumura/Documents/sovanifull202506.pdf');
        ...
        console.log(`\n✅ Successfully parsed SOVANI June PDF!`);
...
testSovaniJune().catch(console.error);
