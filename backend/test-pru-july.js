...
async function testPruJuly() {
    try {
        console.log('================================================================================');
        console.log('Testing: Prudential July PDF (プルデンシャルデータ版_7月.pdf)');
        console.log('================================================================================');

        const pdfBuffer = await fs.readFile('/Users/kohki_okumura/Documents/プルデンシャルデータ版_7月.pdf');
        ...
        console.log(`\n✅ Successfully parsed Prudential July PDF!`);
...
testPruJuly().catch(console.error);
