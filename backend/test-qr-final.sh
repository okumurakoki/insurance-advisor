...
echo "🧪 Testing QR Code Generation with @411iynuh..."
curl -s -X POST https://prudential-insurance-optimizer-mxc9xqfqd-kokiokumuras-projects.vercel.app/api/line/generate-qr \
