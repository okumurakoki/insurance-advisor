...
# 最新のデプロイURL
echo "🧪 Testing QR Code Generation on latest deployment..."
curl -s -X POST https://prudential-insurance-optimizer-9q91ym0n6-kokiokumuras-projects.vercel.app/api/line/generate-qr \
